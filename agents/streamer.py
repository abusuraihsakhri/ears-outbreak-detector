"""
Live WebSocket Distributed Component Telemetry Streamer for ears-outbreak-detector.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "ears-outbreak-detector", "event_type": event_type, "payload": data})
