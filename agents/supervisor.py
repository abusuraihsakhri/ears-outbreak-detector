"""
Supervisor Orchestrator & Operations Intelligence for Ears Outbreak Detector.
...
class SystemSupervisor:
    """Master Distributed Component Coordinator for Ears Outbreak Detector."""
    ...
    def __init__(self, model_provider: str = "mock"):
        ...
        self.llm = LLMFactory.create(model_provider, system_name="Ears Outbreak Detector")
    ...
    def query_supervisory_chat(self, query: str) -> str:
        ...
        prompt = f"Supervisor inquiry for Ears Outbreak Detector under CLSI M100 / EUCAST / CDC NHSN Guidelines: {query}"
