"""
FastAPI REST API Server for Ears Outbreak Detector.
"""
...
app = FastAPI(
    title="Ears Outbreak Detector API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "ears-outbreak-detector", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
